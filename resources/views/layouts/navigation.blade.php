<nav x-data="{ open: false }" class="bg-gray-100 border-b border-gray-100 drop-shadow-md">
    ...
    <div :class="{'absolute bg-gray-100 w-full': open, 'hidden': ! open}" class="hidden sm:hidden">
