        ...
        <div class="bg-gray-700 text-gray-100 flex flex-col lg:flex-row lg:w-2/3 md:w-full sm:w-full justify-between px-10 py-10 lg:py-10 rounded-2xl">
            ...
            <div class="py-5 px-5 lg:flex-1 flex justify-between">
                ...
                <div class="text-right">
                    ...
                    <div>
                        <a href="" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-700 dark:hover:bg-blue-800 dark:focus:ring-blue-800 cursor-pointer">Follow up</a>
                    </div>
                </div>
            </div>
        </div>
