<x-app-layout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="lg:text-center">
                    <h2
                        class="font-heading mb-4 bg-yellow-100 text-orange-800 px-4 py-2 rounded-lg md:w-64 md:mx-auto text-xs font-semibold tracking-widest uppercase title-font">
                        Why choose us?
                    </h2>
                    ...
                    <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                        <div class="relative">
                            <dt>
                                ...
                                <p class="font-heading ml-16 text-lg leading-6 font-bold text-gray-700">Lorem, ipsum dolor.</p>
                            </dt>
                        ...
                        <div class="relative">
                            <dt>
                                ...
                                <p class="font-heading ml-16 text-lg leading-6 font-bold text-gray-700">Lorem, ipsum dolor.
    ...
    <div class="py-12 mb-44">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:text-center">
                <h2 class="text-base font-semibold tracking-wide uppercase">Location</h2>
                ...
                <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-4">
                            ...
                            <dd class="mt-2 text-base text-gray-500">
                                thesiblingscateringservices@gmail.com
                            </dd>
                        </div>
                    </div>
