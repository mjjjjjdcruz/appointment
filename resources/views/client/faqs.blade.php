<x-app-layout>
    ...
    <div class="py-4 bg-white mt-20 mb-44">
                ...
                <ul class="">
                    ...
                    <li class="text-left mb-10">
                        <div class="flex flex-row items-start mb-5">
                            <div
                                class="hidden sm:flex items-center justify-center p-3 mr-3 rounded-full bg-yellow-500 text-white border-4 border-white text-xl font-semibold">
                        ...
                        <div class="flex flex-row items-start">
                            ...
                            <div
                                class="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-yellow-500 text-white border-4 border-white text-xl font-semibold">
